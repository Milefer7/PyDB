...
if __name__ == '__main__':
    ...
    user_input = '''
    INSERT INTO employees (id, name, salary, department) VALUES (1, 'John Doe', 55000.00, 'Engineering'), (2, 'Alice Johnson', 72000.00, 'Marketing'), (3, 'Bob Smith', 64000.00, 'Engineering');
    '''
